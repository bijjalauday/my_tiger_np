...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    train_imgs, val_imgs = opt.train_imgs, opt.val_imgs
    ...
    # Trainloader
    train_loader, dataset = create_dataloader(train_imgs, imgsz, batch_size // WORLD_SIZE, gs, single_cls,
    ...
    # Process 0
    if RANK in [-1, 0]:
        print('starting val loader')
        val_loader = create_dataloader(val_imgs, imgsz, batch_size // WORLD_SIZE * 2, gs, single_cls,
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if RANK in [-1, 0]:
                ...
                callbacks.run('on_train_batch_end', ni, imgs, targets, paths, plots)
            # end batch ------------------------------------------------------------------------------------------------
    ...
    if RANK in [-1, 0]:
        ...
        callbacks.run('on_train_end',  plots)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--train_imgs', nargs='+', help='list of train imgs paths')
    parser.add_argument('--val_imgs',  nargs='+', help='list of val imgs paths')
