...
from ta_pet_id.yolo.utils.general import (LOGGER, Timeout, clip_coords, increment_path, is_ascii,
                                          try_except, user_config_dir, xywh2xyxy, xyxy2xywh)
from ta_pet_id.yolo.utils.metrics import fitness
...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='Arial.ttf', pil=False, example='abc'):
        ...
        if self.pil:  # use PIL
            ...
            self.font = check_font(font=font,
