...
from src.ta_pet_id.core.utils import get_package_path as _get_package_path
from src.ta_pet_id.data_prep import db_utils
from src.ta_pet_id.yolo import data_prep
from src.ta_pet_id.yolo.detect import yolo_detect as _yolo_detect
from src.ta_pet_id.yolo.models.common import (
    DetectMultiBackend as _DetectMultiBackend,
)
from src.ta_pet_id.yolo.train import run as _run
from src.ta_pet_id.yolo.utils.torch_utils import select_device as _select_device
...
def train(context, train_meta_df):
    ...
    model_configs_path = os.path.join(
        _get_package_path(), "src.ta_pet_id", "yolo", "model_conf"
    )
