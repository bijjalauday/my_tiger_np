...
from src.ta_pet_id.pipeline import efficientnet, matcher, yolo
...
def enroll_pet(
    ...
    --------
    >>> import os
    >>> from src.ta_pet_id.core.context import Context
    >>> from src.ta_pet_id.pipeline.main import enroll_pet
    >>> from src.ta_pet_id.data_prep.core import prep_enroll_data
    ...
    for pet_id in house_df["pet_id"].unique():
        ...
        pred_pet_embds = efficientnet.predict(pred_pet_faces, efficientnet_model)
