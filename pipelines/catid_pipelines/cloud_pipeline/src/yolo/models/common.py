...
from src.yolo.utils import TryExcept
from src.yolo.utils.dataloaders import exif_transpose, letterbox
from src.yolo.utils.general import (  # check_requirements,
    LOGGER,
    ROOT,
    Profile,
    check_suffix,
...
from src.yolo.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(
        ...
        from src.yolo.models.experimental import (  # scoped to avoid circular import
            attempt_download,
            attempt_load,
        )
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from src.yolo.utils.downloads import is_url
