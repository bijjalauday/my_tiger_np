...
from src.yolo.utils.datasets import LoadImagesAndLabels
...
def check_anchors(dataset, model, thr=4.0, imgsz=640):
    ...
    if bpr > 0.98:  # threshold to recompute
        ...
        print(f"{s}Anchors are a poor fit to dataset, attempting to improve...")
...
def kmean_anchors(
    ...
    if isinstance(dataset, str):  # *.yaml file
        ...
        # from ta_pet_id.yolo.utils.datasets import LoadImagesAndLabels
