...
def get_package_path():
    ...
    """
    path = os.getcwd()  # ta_pet_id.__path__
    path = os.path.join(path, "src")
    # print(path)
    # print(path[0])
    # print("op.abspath(path[0]) :", op.abspath(path[0]))
    # print(op.dirname(op.abspath(path[0])))
    return path  # op.dirname(op.abspath(path[0]))


def get_package_version():
    """Return the version of the package."""
    return None  # ta_pet_id.__version__
