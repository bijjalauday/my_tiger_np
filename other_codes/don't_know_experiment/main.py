...
from ta_pet_id.pipeline import efficientnet, matcher, yolo,matcher1
...
def enroll_pet(
    ...
    for pet_id in house_df["pet_id"].unique():
        ...
        for i in pred_pet_valid_embds:  # Instead of taking the mean embedding of each cat, we are inserting a new row for each image of each cat. 
            pet_info.append(
                [
